...
<body class="bg-[#fff6f6]">
    ...
    <div class="card max-w-2xl mx-auto mt-24 mb-10 bg-white rounded-box shadow-sm p-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-5">
            ...
            <?php
            $status_class = $status_pembayaran === 'Lunas' ? 'badge bg-[#d4fadd] text-[#227a41] border-none' : 'badge bg-[#fddcdc] text-[#a33] border-none';
            ?>
        ...
        <div class="flex flex-col sm:flex-row gap-2.5">
            <button class="btn bg-gray-200 text-black font-bold"> Cetak Resi</button>
        </div>
    </div>
</body>
