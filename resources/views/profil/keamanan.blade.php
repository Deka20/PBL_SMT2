    ...
    <main class="flex max-w-4xl bg-white rounded-lg overflow-hidden w-full mx-4 md:mx-auto mt-10">
        ...
        <section class="flex-1 p-6 relative w-full rounded-lg shadow-lg min-h-[460px] max-h-[460px]">
            ...
            <form class="space-y-4">
                ...
                <div>
                    <label for="current-password" class="block text-xs font-normal mb-1 text-gray-900">Password saat
                        ini</label>
                ...
                <div>
                    <label for="new-password" class="block text-xs font-normal mb-1 text-gray-900">Password baru</label>
                    <input id="new-password" type="password"
                        class="w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-[#f9d6d6] focus:border-[#f9d6d6]" />
                    <p class="text-[9px] text-gray-300 mt-1">Minimal 8 karakter, mengandung angka</p>
                </div>
                <div>
                    <label for="confirm-password" class="block text-xs font-normal mb-1 text-gray-900">Konfirmasi
                        Password baru</label>
