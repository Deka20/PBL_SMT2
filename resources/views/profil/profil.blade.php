...
<body class="bg-[#fef6f6] min-h-screen flex flex-col">
    ...
    <main class="flex max-w-4xl bg-white rounded-lg overflow-hidden w-full mx-4 md:mx-auto mt-10">
        ...
        <section class="flex-1 p-6 relative max-w-md w-full rounded-lg shadow-lg min-h-[460px] max-h-[460px]"
            ...
            <div class="flex justify-between items-start mb-2">
                ...
                <div class="flex flex-col items-center text-xs text-gray-500" style="min-width: 3rem">
                    ...
                    <label for="profile-upload"
                        ...
                        <img alt="Circular placeholder for profile photo with light gray background with a clear gray outline"
                            class="w-12 h-12 rounded-full" height="48"
            ...
            <form class="space-y-4">
                <div>
                    <label class="block text-xs text-black font-normal mb-1" for="nama">
                        Nama
                    </label>
                    <input
                ...
                <div>
                    <label class="block text-xs text-black font-normal mb-1" for="username">
                        Nama Pengguna
                    </label>
                    <input
                        class="w-full rounded-md bg-[#f3f4f6] border border-gray-200 text-black text-sm px-3 py-2 focus:outline-none focus:ring-1 focus:ring-pink-300"
                ...
                <div>
                    <label class="block text-xs text-black font-normal mb-1" for="birthdate">
                        Tanggal Lahir
                    </label>
                    <input
                        class="w-full rounded-md bg-[#f3f4f6] border border-gray-200 text-black text-sm px-3 py-2 focus:outline-none focus:ring-1 focus:ring-pink-300"
                ...
                <div>
                    <label class="block text-xs text-black font-normal mb-1" for="phone">
                        No. Handphone
                    </label>
                    <input
                        class="w-full rounded-md bg-[#f3f4f6] border border-gray-200 text-black text-sm px-3 py-2 focus:outline-none focus:ring-1 focus:ring-pink-300"
            ...
            <div class="flex items-center justify-end gap-4 mt-8">
                ...
                <button class="text-xs bg-[#f9d6d6] text-black rounded-full px-3 py-1 font-normal" type="button">
                    Simpan Perubahan
                </button>
            </div>
        </section>
