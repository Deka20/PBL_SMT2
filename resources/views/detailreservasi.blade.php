...
<body class="bg-[#fff6f6]">
    ...
    <div class="max-w-2xl mx-auto my-24 bg-white rounded-xl p-6 shadow-sm mt-[100px] mb-10">
        ...
        <div class="flex gap-2.5 flex-wrap sm:flex-row flex-col">
            <button class="btn bg-[#fddcdc] text-[#a33] font-bold px-3.5 py-2.5 rounded-md text-sm">✖ Batalkan
                Reservasi</button>
            <button class="btn bg-gray-200 text-gray-800 font-bold px-3.5 py-2.5 rounded-md text-sm">✎ Ubah
                Reservasi</button>
        </div>
    </div>
</body>
